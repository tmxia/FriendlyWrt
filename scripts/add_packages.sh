...
elif [[ "$VERSION" == "25.12" ]]; then
    PYTHON_PKGS="python3 py3-pip ca-certificates"
else
    PYTHON_PKGS=""
fi
...
echo "Customizations applied for version $VERSION"